...
if (isset($_POST['submit']))    {
    ...
    $allowed = array('mp4','mkv'); //save allowed extenstion in array
    ...
    $sql = "INSERT INTO video(caption,description,moduleCode,file) VALUES('$caption','$description','$module','$fileDestination')";
